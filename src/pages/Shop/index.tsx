...
const Shop: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#090514] pt-32 pb-20 px-4 md:px-6">
        <div className="container mx-auto">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-8 mb-12">
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="text-center lg:text-left">
              ...
              <p className="text-gray-500 font-heading tracking-[0.2em] uppercase text-[10px] md:text-xs mt-2">
          ...
          {/* Filters Bar - Responsive Grid for Mobile */}
          <div className="glass-panel p-4 md:p-6 mb-12 border-white/5 flex flex-col gap-6">
            
            {/* UPDATED CATEGORY GRID FOR MOBILE */}
            <div className="space-y-4">
                ...
                {/* Mobile: 3 columns | Desktop: Flex row */}
                <div className="grid grid-cols-3 gap-2 lg:flex lg:flex-wrap lg:gap-3">
                    {categories.map((cat) => (
                        <button
                        key={cat} onClick={() => handleCategoryChange(cat)}
                        className={cn(
                            "px-2 py-3 rounded-xl text-[9px] md:text-[10px] font-black uppercase tracking-widest transition-all border text-center",
                            activeCategory === cat 
            ...
            {/* Sorting Control */}
            <div className="relative w-full lg:w-64 group border-t border-white/5 pt-4 lg:border-t-0 lg:pt-0 lg:ml-auto">
          ...
          {loading ? (
            <div className="flex flex-col items-center justify-center py-40">
              ...
              <p className="text-gray-500 uppercase tracking-[0.4em] font-heading text-xs text-center">Syncing Tactical Data...</p>
            </div>
